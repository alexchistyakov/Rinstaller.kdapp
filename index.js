/* Compiled by kdc on Tue Aug 12 2014 21:54:03 GMT+0000 (UTC) */
(function() {
/* KDAPP STARTS */
...
logger = "/tmp/_RInstaller." + (getSession()) + ".out";
...
RInstallerInstallerController = (function(_super) {
  ...
  RInstallerInstallerController.prototype.command = function(command, password, data) {
    var name, session;
    switch (command) {
      case INSTALL:
        name = "install";
  ...
  RInstallerInstallerController.prototype.configureWatcher = function(session, cb) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        return _this.kiteHelper.run({
  ...
  RInstallerInstallerController.prototype.watcherDirectory = function() {
