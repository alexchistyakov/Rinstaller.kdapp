...
appName                 = "R"                                                  # App name used for titles and statuses
appCSS                  = "R-installer"                                     # App name used for css
...
launchURL               = false                                 # The url used after the app is configured (can be set to "false")
configureURL            = false                         # The url used to configure app (can be set to "false")
